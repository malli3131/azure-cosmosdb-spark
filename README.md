Azure Cosmos DB Connector for Apache Spark for Scala 2.12
=========================================================
This repo is cloned from Azure & modified to support Scala-2.12 (Note - Azure doesn't have artefacts for Scala 2.12)
